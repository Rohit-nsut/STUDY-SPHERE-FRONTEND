        ...
        >
          ...
          <div className="flex flex-col space-y-2">
            ...
            <textarea 
              ...
              className="form-style resize-x-none min-h-[130px] relative p-3  rounded-lg bg-richblack-700 w-full mt-1 shadow-sm text-white shadow-richblack-50 placeholder:text-richblack-300 outline-none "
            />
            {errors.lectureDesc && (
              <span className="ml-2 text-xs tracking-wide text-pink-200">
